      ...
      <section>
        <div className="container-fluid main-container">
          <ul className="breadcrumb-navigation pt-6">
            ...
            <li className="current">Interview Scheduling & Job Tracking App</li>
          </ul>
          <div className="py-4">
            <div className="row">
              <div className="col-12 col-md-7 pb-3">
                ...
                Scheduling Interviews &  
                  <br />
                  Tracking Jobs Made Easy Via Custom
                  <br />
              ...
              <div className="col-12 col-md-5">
                <div className="py-4">
                  <ul className="top-works">
                    <li className="pt-4 d-none d-sm-block">Job Search Portal</li>
                    <li className="pt-4 d-none d-sm-block">Messaging Module</li>
                  </ul>
                </div>
              </div>
              <div className="py-4">
