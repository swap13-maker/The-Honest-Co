  ...
  return (
    <section className="container overflow-x-hidden pt-5">
      ...
      <div className="gallery pb-md-5 pb-5 mobile-d-none">
        ...
        <Link to="/portfolio/p2p-money-remittance-mobile-application" className="gallery__item media-w-100 d-block">
      ...
      <div className="gallery pb-md-5 pb-5 mobile-d-none">
        <Link to="/portfolio/cab-hailing-travel-itinerary-platform" className="gallery__item gallery__item--lg2 media-w-100 d-block">
        ...
        <Link to="/portfolio/location-sharing-sos-notifications-mobile-app" className="gallery__item gallery__item--hor3 media-w-100 d-block">
        ...
        <Link to="/portfolio/pill-reminder-doctor-appointment-platform" className="gallery__item gallery__item--hor3 media-w-100 d-block">
      ...
      <div className="gallery pb-md-5 pb-5 mobile-d-none">
        <Link to="/portfolio/photo-sharing-online-ecommerce-platform" className="gallery__item gallery__item--hor media-w-100 d-block">
      ...
      <div className="gallery pb-md-5 pb-5 mobile-d-none">
        ...
        <Link to="/portfolio/custom-school-learning-management-platform" className="gallery__item gallery__item--hor2 media-w-100 d-block">
      ...
      <div className="desktop-d-none">
        ...
        <div className="pb-5">
         <Link to="/portfolio/p2p-money-remittance-mobile-application"><img src={mobwork2} className="w-100" alt="peer to peer money remittance app "/>
          <div className="work-heading">P2P Money Remittance Mobile Application </div>
          <div className="work-subheading">
          Banking & Finance · Mobile Apps · P2P Payments 
          </div></Link> 
        </div>
        ...
        <div className="pb-5">
         <Link to="/portfolio/location-sharing-sos-notifications-mobile-app"><img src={mobwork4} className="w-100" alt="location sharing and tracking with SOS calls "/>
          <div className="work-heading">SOS & Location Sharing Application </div>
          <div className="work-subheading">
          Location Sharing & Security · AI & ML · Live Tracking · SOS Mobile App 
          </div></Link> 
        </div>
        ...
        <Link to="/portfolio/pill-reminder-doctor-appointment-platform">  <img src={mobwork5} className="w-100" alt="medicine and appointment reminder mobile app "/>
          <div className="work-heading">Pill and Appointment Reminder Mobile App</div>
          <div className="work-subheading">
          Healthcare Technology · Custom Softwares · Medicine Reminder · Personalized Notifications
          </div></Link>
        </div>
        <div className="pb-5">
          ...
          <div className="work-heading">Online Photo Sharing with E-Commerce </div>
          <div className="work-subheading">
          D2C & E-Commerce · Custom Softwares · Image Sharing · Payment Gateways
          </div></Link>
        </div>
