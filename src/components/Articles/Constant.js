export const ArticleBanner = "Gpay like mobile application, money remittance platform"
...
export const Article2Banner = "Bitcoin trading mobile application and exchange platform"
...
export const Article4Banner = "creating an online business via ecommerce store "
...
export const Article4B4c = "get software developers to build an ecommerce store"

export const Article5Banner = "product forecasting using ai & ml for prediction"
export const Article5B5a = "Enhance product recommendations via AI & ML algorithms"
...
export const Article6Banner = "digital development and educational technology via app development"
...
export const Article7B7a = "advancements in education section & machine learning"
export const Article7B7b = "data driven decisions enhancing student's advancements"

export const Article8Banner = "custom application and platform development for digital development"
...
export const Article9Banner = "automating interview scheduling and digital development"
export const Article9B9a = "efficient interview scheduling via Calendly like application"
export const Article9B9b = "increase efficiency via custom app development"
export const Article9B9c ="automating human resoures processes via digital development "
...
export const Article10B10b = "boosting productivity via machine learning application"
...
export const Article12B12a = "artificial intelligence platforms in fleet management"
